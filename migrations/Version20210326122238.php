 ...
 */
final class Version20210326122238 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_D2294458E368C1BA ON feedback (ownerfeedback_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_D2294458E368C1BA ON feedback');
