 ...
 */
final class Version20210304210947 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE activite (id INT AUTO_INCREMENT NOT NULL, type_activite_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, price DOUBLE PRECISION NOT NULL, date DATE NOT NULL, duration VARCHAR(255) NOT NULL, size INT NOT NULL, image VARCHAR(255) NOT NULL, emplacement VARCHAR(255) NOT NULL, INDEX IDX_B8755515D0165F20 (type_activite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
