 ...
 */
final class Version20210326115636 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE feedback DROP user_id, DROP owner_id');
    }

    public function down(Schema $schema) : void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE feedback ADD user_id INT DEFAULT NULL, ADD owner_id INT NOT NULL');
